...
namespace UnitTestEcoScooterPersistence
{
    ...
    public class PlanningWorkTest
    {
        ...
        private static Maintenance EXPECTED_MAINTENANCE = new Maintenance(EXPECTED_DESCRIPTION, EXPECTED_END_DATE,EXPECTED_START_DATE, EXPECTED_EMPLOYEE);

        //Scooter DAta
        //uses same registerData as StardDAte of Maintenance
        private static ScooterState EXPECTED_STATE = ScooterState.inMaintenance;
        private static Scooter EXPECTED_SCOOTER = new Scooter( EXPECTED_START_DATE, EXPECTED_STATE);
