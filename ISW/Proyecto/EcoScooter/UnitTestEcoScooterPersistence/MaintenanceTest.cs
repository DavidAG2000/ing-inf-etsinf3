...
namespace UnitTestEcoScooterPersistence
{
    ...
    public class MaintenanceTest
    {
        ...
        {
            Maintenance maintenance = new Maintenance(EXPECTED_DESCRIPTION, EXPECTED_END_DATE, EXPECTED_START_DATE, EXPECTED_EMPLOYEE);
        ...
        {
            Maintenance maintenance = new Maintenance(EXPECTED_DESCRIPTION, null, EXPECTED_START_DATE, EXPECTED_EMPLOYEE);
